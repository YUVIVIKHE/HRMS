...
<aside class="sidebar">
  ...
  <div class="sidebar-section">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="my_leaves.php"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>My Leaves</a>
...
<div class="main-content">
  ...
  <div class="page-body">
    ...
    <div class="table-wrap">
      ...
      <table>
        <thead>
          <tr><th>Date</th><th>Clock In</th><th>Clock Out</th><th>Work Hours</th><th>Status</th><th>Location</th></tr>
        </thead>
        <tbody>
          <?php if(empty($logs)): ?>
            <tr class="empty-row"><td colspan="6">No records this month.</td></tr>
