...
try {
    $__db = getDB();
    $__ls = $__db->prepare("SELECT setting_value FROM app_settings WHERE setting_key='company_logo'");
    $__ls->execute(); $_companyLogo = $__ls->fetchColumn() ?: '';
} catch (Exception $e) {}
?>
<aside class="sidebar">
  ...
  <div class="sidebar-section">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="project_expenses.php" class="<?= $p==='project_expenses.php'?'active':'' ?>">
  ...
  <div class="sidebar-section">
    ...
    <nav class="sidebar-nav">
      <a href="users.php" class="<?= $p==='users.php'?'active':'' ?>">
        <svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>
        Users
      </a>
      <a href="employees.php" class="<?= in_array($p,['employees.php','add_employee.php','edit_employee.php'])?'active':'' ?>">
        <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        Employees
      </a>
  ...
  <div class="sidebar-section">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="fnf_settlement.php" class="<?= $p==='fnf_settlement.php'?'active':'' ?>">
