...
<div class="main-content">
  <header class="topbar">
    <div class="topbar-left"><span class="page-title">ACL Requests</span><span class="page-breadcrumb">Manager holiday work requests</span></div>
  ...
  <div class="page-body">
    ...
    <div class="table-wrap">
      <div class="table-toolbar"><h2>Manager ACL Requests <span style="font-weight:400;color:var(--muted);font-size:13px;">(<?= count($requests) ?>)</span></h2></div>
      <table>
        <thead><tr><th>Manager</th><th>Work Date</th><th>Reason</th><th style="text-align:center;">Hours</th><th>Status</th><th style="width:160px;"></th></tr></thead>
        <tbody>
          <?php if(empty($requests)): ?><tr class="empty-row"><td colspan="6">No ACL requests from managers.</td></tr>
