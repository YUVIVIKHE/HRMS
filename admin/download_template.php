...
// Column order — use "department" (name) not "department_id"
$headers = [
    ...
    'permanent_city', 'permanent_state', 'permanent_zip_code',
    'gross_salary', 'account_type', 'account_number', 'ifsc_code',
...
// Sample row — all values are real valid data that will import successfully
// Users replace this row with their own data
$sample = [
    'first_name'               => 'John',
    'last_name'                => 'Doe',
